...
[IMPORTANT]
====
If you're using the default configuration of HellHound HTTP package (`hellhound.components.webserver/default-factory`).
then you don't need to learn about the router and can safely skip this section.,
====
